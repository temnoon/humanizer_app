...
class MassAttributeHarvester:
    ...
    def process_single_book(self, job: BatchJob) -> Tuple[bool, str, Dict]:
        ...
        try:
            ...
            # Save legacy format
            self._save_legacy_format(book_id, selected_paras)
    ...
    def _save_legacy_format(self, book_id: str, selected_paras: list):
